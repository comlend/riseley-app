...
export class RegisterBuildingManagerPage {
  public signupForm;
  user: { firstName?: any, lastName?: any, email?: any, pass?: any, role?: any } = {};
  formData: any;
  loading: any;
  errormessage: any;
  ...
  signupUser() {
    ...
    if (!this.signupForm.controls.firstName.valid || !this.signupForm.controls.lastName.valid ||
      ...
      this.firebase.signupManager(this.signupForm.value.email, this.signupForm.value.password, this.signupForm.value.firstName, this.signupForm.value.lastName, createdAt, this.userType, this.imageData, this.signupForm.value.mobile, this.signupForm.value.role)
        .then((data) => {
